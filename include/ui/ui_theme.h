...
// Доступные темы
typedef enum {
    THEME_BTOP_DARK,         // Темная тема в стиле btop
    THEME_BTOP_NEON,         // Неоновая тема
    THEME_BTOP_MATRIX,       // Матричная тема
    THEME_BTOP_LIGHT,        // Светлая тема
    THEME_BTOP_CUSTOM        // Пользовательская тема
} theme_type_t;
